...
def load_eval_dataset(dataset_root_dir='dataset/UGD-12k'):
    image_path = dataset_root_dir + '/eval/image/*'
    matte_path = dataset_root_dir + '/eval/alpha/*'
...
if __name__ == '__main__':
    ...
    dataset = load_eval_dataset('src/datasets/UGD-12k')
